...
// ELO = base avril 2026 + ajustements amicaux juin 2026 (K=30)
export const TEAMS = [
  ...
  { name:"South Korea",        code:"KOR", confederation:"AFC",      group:"A", fifa_ranking:23, elo:1650 },
  ...
  { name:"Qatar",              code:"QAT", confederation:"AFC",      group:"B", fifa_ranking:37, elo:1530 },
...
export function getTeam(name) {
  ...
  return TEAMS.find(t => {
    ...
    return tn === n || t.code.toLowerCase() === name.toLowerCase();
  });
}
