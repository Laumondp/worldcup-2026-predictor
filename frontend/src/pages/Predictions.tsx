    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="text-center">
        ...
        <p className="text-gray-400">
          Select two teams to get AI-powered match predictions
        </p>
      </div>
      ...
      {prediction?.data && (
        <div className="card">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Probability Chart */}
            <div>
              <h3 className="text-lg font-semibold mb-4 text-center">Win Probabilities</h3>
              <ProbabilityChart
            ...
            <div className="space-y-6">
              <div className="bg-gray-700/50 rounded-xl p-6 text-center">
                <div className="text-sm text-gray-400 mb-2">Predicted Outcome</div>
              ...
              <div className="bg-gray-700/50 rounded-xl p-6 text-center">
                <div className="text-sm text-gray-400 mb-2">Predicted Score</div>
      ...
      {h2h?.data && h2h.data.total_matches > 0 && (
        <div className="card">
          ...
          <div className="mt-4 text-center text-gray-400">
            {h2h.data.total_matches} matches played | Goals: {h2h.data.team1_goals} - {h2h.data.team2_goals}
          </div>
        </div>
      )}
    </div>
